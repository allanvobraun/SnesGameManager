...
theme_config_dialog = f"pyuic5 -x '{ROOT_DIR}/config/ui/themeConfig_dialog.ui'" \
           f" -o '{ROOT_DIR}/config/ui/themeConfig_dialog.py'"

ui_list = [main_window, dw_dialog, emulation_config_dialog, theme_config_dialog]
